...
## eye-Lancedb
This companion crate implements a eye vector store based on Lancedb.
...
You can also run `cargo add eye-lancedb eye-core` to add the most recent versions of the dependencies to your project.
