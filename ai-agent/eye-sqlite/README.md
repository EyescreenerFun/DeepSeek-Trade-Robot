...
This companion crate implements a eye vector store based on SQLite.
...
You can also run `cargo add eye-sqlite eye-core` to add the most recent versions of the dependencies to your project.
