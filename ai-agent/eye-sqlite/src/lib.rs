use eye::embeddings::{Embedding, EmbeddingModel};
use eye::vector_store::{VectorStoreError, VectorStoreIndex};
use eye::OneOrMany;
...
/// SQLite vector store implementation for eye.
///
/// This crate provides a SQLite-based vector store implementation that can be used with eye.
