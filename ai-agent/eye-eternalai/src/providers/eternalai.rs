//! EternalAI API client and eye integration
//!
//! # Example
//! ```
...
use eye::completion::{CompletionError, CompletionRequest};
use eye::embeddings::{EmbeddingError, EmbeddingsBuilder};
use eye::extractor::ExtractorBuilder;
use eye::{completion, embeddings, Embed};
...
impl Client {
    ...
    /// let eternalai = Client::new("your-open-ai-api-key");
    ///
    /// let embedding_model = eternalai.embedding_model("model-unknown-to-eye", 3072);
    /// ```
