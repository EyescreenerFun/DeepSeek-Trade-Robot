//! Azure OpenAI API client and eye integration
//!
//! # Example
//! ```
//! use eye::providers::azure;
//!
...
impl Client {
    ...
    /// # Example
    /// ```
    /// use eye::providers::azure::{Client, self};
    ///
    ...
    /// let azure = Client::new("YOUR_API_KEY", "YOUR_API_VERSION", "YOUR_ENDPOINT");
    ///
    /// let embedding_model = azure.embedding_model("model-unknown-to-eye", 3072);
    /// ```
