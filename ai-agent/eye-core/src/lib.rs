...
//! eye provides a consistent API for working with LLMs and embeddings. Specifically,
...
//!
//! ## Agents
//! eye also provides high-level abstractions over LLMs in the form of the [Agent](crate::agent::Agent) type.
//!
...
//! eye provides a common interface for working with vector stores and indexes. Specifically, the library
...
//! # Integrations
//! ## Model Providers
//! eye natively supports the following completion and embedding model provider integrations:
//! - OpenAI
//! - Cohere
//! - Anthropic
//! - Perplexity
...
//!
//! ## Vector Stores
//! eye currently supports the following vector store integrations via companion crates:
//! - `eye-mongodb`: Vector store implementation for MongoDB
//! - `eye-lancedb`: Vector store implementation for LanceDB
//! - `eye-neo4j`: Vector store implementation for Neo4j
//! - `eye-qdrant`: Vector store implementation for Qdrant
//!
