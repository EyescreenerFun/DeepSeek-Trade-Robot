...
You can also run `cargo add eye-neo4j eye-core` to add the most recent versions of the dependencies to your project.
...
- Add support for creating the vector index through eye.
