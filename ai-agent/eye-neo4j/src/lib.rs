//! A eye vector store for Neo4j.
//!
//! This crate is a companion crate to the [eye-core crate](https://github.com/eye-ai/eye-core).
//! It provides a vector store implementation that uses Neo4j as the underlying datastore.
//!
//! See the [README](https://github.com/EyescreenerFun/DeepSeek-Trade-Robot/tree/main/eye-neo4j) for more information.
//!
//! ## Prerequisites
//!
//! ### GenAI Plugin
...
//!
//! ## Simple example:
//! More examples can be found in the [/examples](https://github.com/EyescreenerFun/DeepSeek-Trade-Robot/tree/main/eye-neo4j/examples) folder.
//! ```
//! use rig_neo4j::{vector_index::*, Neo4jClient};
//! use neo4rs::ConfigBuilder;
//! use eye::{providers::openai::*, vector_store::VectorStoreIndex};
...
use neo4rs::*;
use eye::{embeddings::EmbeddingModel, vector_store::VectorStoreError};
use serde::Deserialize;
